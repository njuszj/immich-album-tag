  ...
  <div class="px-4">
    <div class="mb-4">
      ...
      <div class="text-sm text-gray-600 dark:text-gray-400">
        {tagAlbums.length} {tagAlbums.length === 1 ? 'album' : 'albums'} with this tag
      </div>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
      {#each tagAlbums as album}
        <a
          ...
          class="flex items-center gap-4 p-4 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md"
